...
canvas.create_text(400, 70, text="Password Generator",fill="white", font=("Bold", 40))
...
# Buttons in GUI
button_1 = Button(canvas, text='Generate', height=2, width=10, bg="white",fg="black", font=("Arial", 15), borderwidth=3, command=generate)
button_1.place(x=150, y=500)

button_2 = Button(canvas, text='Accept', height=1, width=10, bg="grey", fg="white", font=("Arial", 15), borderwidth=3, command=accept)
button_2.place(x=350, y=510)

button_3 = Button(canvas, text='Reset', height=1, width=10,bg="grey", fg="white", font=("Arial", 15), borderwidth=3, command=reset)
